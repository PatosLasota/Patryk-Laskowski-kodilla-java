...
class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        // given
        User user1 = new User("developer1", "Jan Kowalski");
        User user2 = new User("developer2", "Anna Nowak");

        Task task1 = new Task("Implement feature A", "Description A", user1, user2,
                LocalDate.now().minusDays(10), LocalDate.now().plusDays(5));
        Task task2 = new Task("Fix bug B", "Description B", user2, user1,
                LocalDate.now().minusDays(5), LocalDate.now().plusDays(3));
        Task task3 = new Task("Write tests C", "Description C", user1, user2,
                LocalDate.now().minusDays(7), LocalDate.now().plusDays(2));
        ...
        Board projectBoard = new Board("Project X");
        projectBoard.addTaskList(toDoList);
        projectBoard.addTaskList(inProgressList);
        projectBoard.addTaskList(doneList);

        // when
        double averageDays = projectBoard.getTaskLists().stream()
